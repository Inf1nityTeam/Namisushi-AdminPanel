export const tableColumns = [
    ...
    {prop: 'weight', label: 'Вес, г', width: '80px', isSortable:true},
    {prop: 'cost', label: 'Стоимость, Р', width: '120px', isSortable:true},
    {prop: 'show', label: 'Статус', width: '80px', isSortable:false},
    {prop: 'actions', label: 'Действия', width: '110px', isSortable:false},
]
