...
.modal-section {
  ...
  &__title {
    ...
    top: -9px;
    left: 10px;
    background: linear-gradient(to bottom, rgba(255, 255, 255, 1) 60%, rgba(255, 255, 255, .3));
    border-radius: 2px;
    border: none;
    padding: 0 3px;
...
.el-select-dropdown__item:hover {
  background: linear-gradient(180deg, rgba(162, 192, 250, .08) 0%, rgba(10, 56, 171, .07) 100%) !important;
}
</style>